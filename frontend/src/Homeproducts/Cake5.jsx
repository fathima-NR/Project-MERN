...
function Cake5() {
    let Cake5 = [
        {cakeimg:'https://flowera.in/uploads/tempDir/Unicorn-cake-for-brithday-300X300.jpg',
            cakename:'Unicorn Cake',
            price:'850'
      
          },
          {cakeimg:'https://flowera.in/uploads/tempDir/Numeric-Cake-1-300X300.jpg',
            cakename: 'Numeric Cake',
            price:'750'
          },
...
<ul style={{ display: "flex", flexWrap: "wrap" }}>
            {Cake5.map((Cake5,index) => (
              <li className="col-xl-3 col-lg-4 col-md-6 col-sm-6 ">
                
                  <div className="card mt-5" style={{ width: '15rem' }}>
                    <img src={Cake5.cakeimg} className="card-img-top" alt="Placeholder Image" />
                    <div className="card-body">
                      <h5 className="card-title">{Cake5.cakename}</h5>
                      <p className="card-text"><FaRupeeSign />{Cake5.price}/-  <span className='ms-5 fs-4 text-white bg-black p-1' style={{ borderRadius: 10 }}><FaShoppingCart /></span></p>
...
<h5 className='text-muted'>Order Lip Smacking Delicious designer Cake From Flowera</h5>
<p className='mt-4'>
Who doesn't love designer? How can someone think of denying a juicy, spongy, sweet delight, dipped in creamy milk? It is the most loved dessert that's enjoyed by 
