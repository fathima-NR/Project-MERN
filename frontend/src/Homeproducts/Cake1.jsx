...
function Cake1() {
    let Cake1 = [
        {cakeimg:'https://flowera.in/uploads/tempDir/Rasmalai-Cake-1-300X300.jpg',
            cakename:'Lovely Rasmalai Cake',
            price:'850'
      
          },
          {cakeimg:'https://flowera.in/uploads/tempDir/Rasmalai-Cake-2-1-300X300.jpg',
            cakename: 'Rasmalai Cake',
            price:'750'
          },
          {cakeimg:'https://flowera.in/uploads/tempDir/RaSmalai-Cake--300X300.jpg',
            cakename:'Delicious Rasmalai',
        price:'800'       
      }
...
<ul style={{ display: "flex", flexWrap: "wrap" }}>
            {Cake1.map((Cake1,index) => (
              <li className="col-xl-3 col-lg-4 col-md-6 col-sm-6 ">
                
                  <div className="card mt-5" style={{ width: '15rem' }}>
                    <img src={Cake1.cakeimg} className="card-img-top" alt="Placeholder Image" />
                    <div className="card-body">
                      <h5 className="card-title">{Cake1.cakename}</h5>
                      <p className="card-text"><FaRupeeSign />{Cake1.price}/-  <span className='ms-5 fs-4 text-white bg-black p-1' style={{ borderRadius: 10 }}><FaShoppingCart /></span></p>
...
<h5 className='text-muted'>Order Lip Smacking Delicious Rasmalai Cake From Flowera</h5>
<p className='mt-4'>
Who doesn't love Rasmalai? How can someone think of denying a juicy, spongy, sweet delight, dipped in creamy milk? It is the most loved dessert that's enjoyed by 
